...
public class DBQuery {
    ...
    // 插入的数据
    private void insertData(PetBean petBean) {
        ContentValues data = new ContentValues();
        data.put("id", petBean.getId());
    ...
    // 修改条件
    // 满足修改的值
    private void updateData(int id, String key, String value) {
        ContentValues data = new ContentValues();
        data.put(key, value);
    ...
    // 分组筛选关键字
    // 排序
    private List<String> queryData(int id, String key) {
